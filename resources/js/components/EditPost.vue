        ...
        <div class="card-body">
            ...
            <form @submit.prevent="updatePost" enctype="multipart/form-data">
                ...
                <div class="form-group mb-2">
                    ...
                    <input type="text" class="form-control" v-model="price" placeholder="Enter product price">
                </div>
                ...
                <button type="submit" class="btn btn-primary mt-4 mb-4"> Update Product</button>
